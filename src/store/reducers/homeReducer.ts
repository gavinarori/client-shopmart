...
export const get_product = createAsyncThunk("product/get_product", async (slug: string, { fulfillWithValue }) => {
  try {
...
export const get_banners = createAsyncThunk("product/get_banners", async (_, { fulfillWithValue }) => {
  try {
...
export const customer_review = createAsyncThunk("review/customer_review", async (info: any, { fulfillWithValue }) => {
  try {
